<# =================================================================================================
 CS-Toolbox-VaultViewDesktopIcon.ps1  (v1.3)
...
[CmdletBinding()]
param(
    [string]$ZipUrl = "https://github.com/dmooney-cs/dev01/raw/refs/heads/main/vault-viewer-zip.zip",
    [switch]$Silent,
    [switch]$ExportOnly
)
...
$LogFile    = Join-Path $CollectedInfo "CS-Toolbox-VaultViewDesktopIcon.log"
$ExportJson = Join-Path $CollectedInfo "CS-Toolbox-VaultViewDesktopIcon.json"
